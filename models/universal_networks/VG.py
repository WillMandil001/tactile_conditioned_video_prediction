...
class Model:
    ...
    def save_model(self):
        torch.save({'encoder': self.encoder, 'decoder': self.decoder, 'frame_predictor': self.frame_predictor, 'features': self.features}, self.model_dir + "VG_model" + self.model_name_save_appendix)
